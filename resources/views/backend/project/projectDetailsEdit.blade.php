                            ...
                            <form action="{{ route('projectDetailsUpdate', $proj) }}" method="POST">
                                ...
                                <div class="row match-height">
                                    ...
                                    <div class="col-md-3 changeColStyle">
                                        ...
                                        <input type="date" id="ord_date" class="form-control inputFieldHeight" name="ord_date" placeholder="Work Order Date" required value="{{ $proj->ord_date }}">
                                        @error('ord_date')
                                            <div class="btn btn-sm btn-danger">{{ $message }}  </div>
                                        @enderror
                                    </div>
                                    <div class="col-md-3 changeColStyle">
                                        ...
                                        <input type="date" id="hnd_over_date" class="form-control inputFieldHeight" name="hnd_over_date" placeholder="Work Order Date" required value="{{ $proj->hnd_over_date }}">
                                        @error('hnd_over_date')
                                            <div class="btn btn-sm btn-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
