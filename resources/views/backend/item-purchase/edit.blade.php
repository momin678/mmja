            ...
            <div class="content-body">
                <div class="row" id="table-bordered">
                    <div class="col-12 col-sm-10 col-md-10 col-lg-10">
                        <form action="{{route('purchase.update', $purchase_temp_info->id)}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method("PUT")
                            ...
                            <div class="card mb-1">
                                <div class="card-body content-padding">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3 col-12">
                                            <label for="pr_id">PR List</label>
                                            <select  id="pr_id" class="form-control" required disabled>
                                                <option value=""></option>
                                                @foreach ($pr_lists as $pr_list)
                                                    <option value="{{$pr_list->id}}" {{$purchase_temp_info->pr_id == $pr_list->id ? "selected": ""}}>{{$pr_list->purchase_no}}</option>
                                                @endforeach
                                                <input type="hidden" name="pr_id" value="{{$purchase_temp_info->pr_id}}">
                                            </select>
                                ...
                                <div class="card-body content-padding">
                                    <div class="row">
                                        <div class="col-sm-6 col-12">
                                            ...
                                            <select name="item_list_id" id="item_list_id" class="form-control">
                                                ...
                                                @foreach ($items as $key => $item)
                                                    <option value="{{$item->id}}" id="{{$item_ids[$key]->style_code}}" >{{$item->item_name}}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-sm-3 col-12">
                                            ...
                                            <input type="text" readonly class="form-control" name="purchase_rate" id="purchase_rate" oninput="validate(this)" step=".01">
                            ...
                            <table class="table table-sm table-bordered">
                                ...
                                <tbody id="tempLists">
                                    ...
                                    <tr class="border-top" >
                                        ...
                                        <td colspan="2">
                                            @php
                                                $amount = $purchase_details_temps->sum('total_amount') - $purchase_details_temps->sum('vat_amount');
                                            @endphp
                                    ...
                                    <tr >
                                        ...
                                        <td colspan="2">
                                            {{ number_format((float)$purchase_details_temps->sum('vat_amount'), 2, '.', '')}}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td  colspan="6" class="text-right">Net Amount (AED):</td>
                                        <td colspan="2">
                                            {{number_format((float)$purchase_details_temps->sum('total_amount'), 2, '.', '') }}
                                        </td>
                                    </tr>
