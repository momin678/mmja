                            ...
                            <table class="table table-sm table-hover exprortTable">
                                <thead class="thead-light">
                                    <tr style="height: 50px;">
                                        <th>Vendor name</th>
                                        <th class="text-right pl-2">Invoice No</th>
                                        <th class="text-right pl-2">Vat Amount</th>
                                        <th class="text-right pl-2">Net Amount</th>
                                        <th class="text-right pl-2">Total Amount</th>
                                    </tr>
                                </thead>
                                <tbody class="user-table-body">
                                    @foreach ($invoicess as $item)
                                        <tr>
                                            <td>{{$item->invoice($item->invoice_no)}}</td>
                                            <td>{{$item->invoice_no}}</td>
                                            <td class="text-right pr-2">0</td>
                                            <td class="text-right pr-2">0</td>
                                            <td class="text-right pr-2">{{$item->total_net_amount}}</td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
