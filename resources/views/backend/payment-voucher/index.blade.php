                    ...
                    <div class="col-12 col-sm-10 col-md-10 col-lg-10">
                        <div class="table-responsive card">
                            ...
                            <table class="table table-sm table-bordered">
                                ...
                                <tbody>
                                    @foreach ($invoice_postings as $item)
                                        <tr class="data-row">
                                            <td>{{$item->invoice_posting_no}}</td>
                                            <td>{{$item->goods_received_no}}</td>
                                            <td>{{$item->partInfo->pi_name}}</td>
                                            <td>
                                                <a href="{{route('pv-process', $item->id)}}" class="btn btn-sm btn-warning">View</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
                        ...
                        <div>{{$invoice_postings->links()}}</div>
                    </div>
