                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="{{ route('sales-person.create')}}" class="btn btn-primary">Add New</a>
                            </div>
                            <div class="card-body">
                                <!-- table bordered -->
                                <div class="table-responsive">
                                    <table class="table table-bordered mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            <td>
                                                <a href="{{route('sales-person.edit', $person->id)}}" class="btn btn-icon btn-success"><i class="bx bx-edit"></i></a>
