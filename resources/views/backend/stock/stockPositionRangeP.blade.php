        ...
        <div class="content-wrapper">
            <div class="content-body">
                ...
                <section id="widgets-Statistics">
                    ...
                    <div class="row pt-2">
                        <div class="col-md-12">
                            <a href="{{ route('printStockPositionRangeP',[$from,$to]) }}" class="btn btn-sm btn-info float-right"
                        ...
                        @if(1==1)
                                ...
                                @endphp
                                    <tr>
                                        ...
                                        <td>{{$itmXsC= isset($itmXs)? $itmXs->purchaseRange($from,$to):0 }}</td>
                                        <td>{{ $itmSC =isset($itmS)? $itmS->purchaseRange($from,$to):0 }}</td>
                                        <td>{{$itmMC= isset($itmM)? $itmM->purchaseRange($from,$to):0 }}</td>
                                        <td>{{$itmLC= isset($itmL)? $itmL->purchaseRange($from,$to):0 }}</td>
                                        <td>{{$itmXlC= isset($itmXl)? $itmXl->purchaseRange($from,$to):0 }}</td>
                                        <td>{{$itmXxlC= isset($itmXxl)? $itmXxl->purchaseRange($from,$to):0 }}</td>
                                        <td>{{ $itmXxxlC=isset($itmXxxl)? $itmXxxl->purchaseRange($from,$to):0 }}</td>
                                        <td>{{  $itmXsC+$itmSC+$itmMC+$itmLC+$itmXlC+$itmXxlC+$itmXxxlC }}</td>
                                    </tr>
                                    @php
