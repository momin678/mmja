        ...
        <div class="content-wrapper">
            <div class="content-body">
                ...
                <section id="widgets-Statistics">
                            ...
                            <form action="{{ route('searchStockPositionDate') }}" method="GET">
                                ...
                                <div class="row form-group col-left-padding">
                                    <input type="text" class="form-control col-9" name="date"
                                        placeholder="Select Date" onfocus="(this.type='date')" value="{{ $searchDate }}" id="date" required>
                    ...
                    <div class="row pt-2">
                        <div class="col-md-12">
                            <a href="{{ route('printStockPositionDate',$date) }}" class="btn btn-sm btn-info float-right"
