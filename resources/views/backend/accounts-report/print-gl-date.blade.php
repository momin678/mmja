            ...
            <section id="widgets-Statistics">
                ...
                <div class="row">
                    ...
                    <table   class="table table-sm table-bordered">
                        <tr>
                            <th class="text-center" colspan="5">General Ledger {{$date}} </th>
                        </tr>
                        ...
                        <tr>                                
                            ...
                            @foreach (App\JournalRecordsTemp::where('account_head_id', $unique_acc_head->account_head_id )->where('journal_date', $date)->get() as $record)
                                ...
                                @endphp
                                @foreach (App\JournalRecordsTemp::where('journal_temp_id',$record->journal_temp_id)->where('journal_date', $date)->where('transaction_type', $reverse)->get() as $ledger_record)
                                <tr>
