        ...
        <div class="content-wrapper">
            <div class="content-body">
                ...
                <section id="widgets-Statistics">
                    ...
                    <div class="row pt-2">
                        <div class="col-md-12">
                            <a href="{{ route('print-gl-date',$date) }}" class="btn btn-sm btn-info float-right"
                        ...
                        <table   class="table table-sm table-bordered">
                            ...
                            @foreach (App\JournalRecordsTemp::where('journal_date', $date)->distinct()->get('account_head_id') as $unique_acc_head)
                            <tr>
                            ...
                            <tr>
                                ...
                                @php
                                    ...
                                    $each_ledger_cr=0;
                                @endphp
                                @foreach (App\JournalRecordsTemp::where('account_head_id', $unique_acc_head->account_head_id )->where('journal_date', $date)->get() as $record)

                                    @php
                                        $reverse= $record->transaction_type== "DR" ? "CR" : "DR";
                                    @endphp
                                    @foreach (App\JournalRecordsTemp::where('journal_temp_id',$record->journal_temp_id)->where('transaction_type', $reverse)->where('journal_date', $date)->get() as $ledger_record)
                                    <tr>
