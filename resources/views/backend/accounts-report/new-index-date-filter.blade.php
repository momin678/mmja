                        ...
                        <section id="widgets-Statistics">
                            <div class="cardStyleChange">
                                ...
                                <div class="card-body d-flex justify-content-start  pt-0 pb-0">
                                    ...
                                    <div class="col-md-3">
                                        <form action="{{ route('new-general-filter') }}" method="GET" class="d-flex">
                                            <div class="row">
                                                    <div class="col-md-9 ">
                                ...
                                <div class="card-body pt-0 pb-0">
                                    <table class="table table-sm">
                                        @foreach (App\JournalRecord::where('journal_date', $date)->where('account_head_id',$acc_head)->distinct()->get('account_head_id') as $unique_acc_head)
                                        @php
                                            $pre_bl=$unique_acc_head->openingBalanceLadgerDR($unique_acc_head->account_head_id,$date)-$unique_acc_head->openingBalanceLadgerCR($unique_acc_head->account_head_id,$date);
                                        @endphp
                                        <tr>
                                            ...
                                            <th class="text-right">{{ number_format($unique_acc_head->openingBalanceLadgerDR($unique_acc_head->account_head_id,$date)-$unique_acc_head->openingBalanceLadgerCR($unique_acc_head->account_head_id,$date),2) }}</th>
                                        </tr>
                                        <tr>
                                            <th>Date</th>
                                            <th>Narration</th>
