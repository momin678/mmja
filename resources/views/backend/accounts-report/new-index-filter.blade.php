                        ...
                        <section id="widgets-Statistics">
                            <div class="cardStyleChange">
                                ...
                                <div class="card-body d-flex justify-content-start  pt-0 pb-0">
                                    ...
                                    <div class="col-md-4">
                                        <form action="{{ route('new-general-filter-range-all') }}" method="GET" class="d-flex">
                                ...
                                <div class="card-body pt-0 pb-0">
                                    <table class="table table-sm">
                                        @foreach (App\JournalRecord::where('account_head_id',$acc_head)->distinct()->get('account_head_id') as $unique_acc_head)
                                        <tr>
