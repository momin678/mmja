                            ...
                            <table class="table mb-0 table-sm table-hover exprortTable">
                                <thead  class="thead-light">
                                    <tr style="height: 50px;">
                                        <th>Invoice Count</th>
                                        <th>Invoice Sales</th>
                                        <th>Inv Sales with Tax</th>
                                        <th>Credit Note Count</th>
                                        <th>Credit Note Sales</th>
                                        <th>Credit Note Sales with Tax</th>
                                        <th>Total Sales</th>
                                        <th>Total Credit note Sale with Tax</th>
                                        <th>Sales Person</th>
                                    </tr>
                                </thead>
                                <tbody class="user-table-body">
                                    ...
                                    @foreach ($persons as $key => $person)
                                        ...
                                        <tr class="trFontSize">
                                            ...
                                            <td>{{$person->sales_amount()}}</td>
                                            <td>{{$person->sales_with_tax()}}</td>
                                            <td></td>
                                            <td></td>
                                            <td></td>
                                            <td></td>
