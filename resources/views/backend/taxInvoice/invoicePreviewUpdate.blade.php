                                            ...
                                            <div class="card-body">
                                                <div class="row d-flex align-items-center">
                                                    ...
                                                    <div class="col-sm-3 form-group customer-select">
                                                        ...
                                                        <select name="customer_name" id="customer_name"
                                                            ...
                                                            @foreach ($customers as $customer)
                                                                <option value="{{ $customer->pi_code }}" {{ $customer->pi_code == $invoice->customer_name ? 'selected' : '' }}>
                                                                    {{ $customer->pi_name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    <div class="col-sm-3 form-group">
                                                        ...
                                                        <input type="text" class="form-control" value="{{ $invoice->contact_no }}" name="contact_no"
                                                            id="contact_no" readonly>
                                                    </div>

                                                    <div class="col-sm-3 form-group">
                                                        <label for="">Shipping Address</label>
                                                        <input type="text" class="form-control"  value="{{ $invoice->address }}" name="address"
                                                            id="address" readonly>
                                                    </div>
                                                </div>
                                            </div>
