                                ...
                                <div class="col-md-5">
                                    <div class="form-group row">
                                        ...
                                        <input type="number" name="amount_from" placeholder="Amount" min="0"
                                            step="any" value="{{$invoice->invoiceAmount ? number_format((float)($invoice->invoiceAmount->amount_from), 2,'.',''): '0.00'   }}" class="form-control col-4" id="amount_from">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group row">
                                        ...
                                        <input type="number" name="amount_to" placeholder="Amount" step="any"
                                            class="form-control col-4" value="{{  $invoice->invoiceAmount ? ($invoice->invoiceAmount->amount_to>0?  number_format((float)($invoice->invoiceAmount->amount_to), 2,'.',''): '0.00'): '0.00'   }}" id="amount_to" readonly>
                                    </div>
