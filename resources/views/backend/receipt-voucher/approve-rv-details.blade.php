                    ...
                    <div class="row">
                        <div class="col-md-10">
                            ...
                            <form action="{{ route('receipt-voucher.store') }}" method="POST">
                                ...
                                <a class="btn btn-warning" href="{{route('approver-rv-approve', $rv_info->id)}}">Approve</a>
                                </div>
                            </form>
                            <div id="approveRejectedForm" style="display: none;">
                                <form action="{{route("approve-rv-reviece")}}" method="post">
                                    @csrf
                                    <div class="row">
                                        <div class="col-sm-10 col-12">
                                            <label for="mode">Comment</label>
                                            <input type="text" required placeholder="Comment" class="form-control" name="comment">
                                            <input type="hidden" required value="{{$rv_info->rv_no}}" class="form-control" name="purchase_no">
                                        </div>
