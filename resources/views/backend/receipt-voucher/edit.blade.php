                ...
                <section id="widgets-Statistics">
                    <div class="row">
                        <div class="col-md-10">
                            ...
                            <form action="{{ route('receipt-voucher.update', $rv_info->id) }}" method="POST">
                                @method("PUT")
                                @csrf
                                <div class="row">
                                    <div class="col-12">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-3 col-12">
                                                ...
                                                <input type="hidden" id="max_paid" value="{{number_format((float)( $rv_info->tax_invoice_items($rv_info->tax_invoice_id)->sum("vat_amount") + $rv_info->tax_invoice_items($rv_info->tax_invoice_id)->sum("total_unit_price")),'2','.','') }}">
