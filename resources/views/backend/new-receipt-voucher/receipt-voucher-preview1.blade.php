...
<section class="print-hideen border-bottom">
    <div class="d-flex flex-row-reverse">
        ...
        <div class="py-1 pr-1"><a href="{{route("receipt-voucher-view-pdf", $receipt_voucher->id)}}" class="btn btn-icon btn-primary"><i class='bx bxs-file-pdf'></i></a></div>
    ...
    <section class="m-4">
        <div class="table-responsive">
            <table class="table table-borderless table-sm">
                <tr>
                    <td><b>Paid By</b></td>
                    <td><b>:</b> {{$receipt_voucher->party->pi_name}}</td>
                    <td><b>Date</b></td>
                    <td><b>:</b> {{$receipt_voucher->payment_date}}</td>
                </tr>
                <tr>
                    <td><b>Payment Type</b></td>
                    <td><b>:</b> {{$receipt_voucher->type}}</td>
                    <td><b>Payment Mode</b></td>
                    <td><b>:</b> {{$receipt_voucher->pay_mode}}</td>
                </tr>
                <tr>
                    <td><b>Amount</b></td>
                    <td><b>:</b> {{$receipt_voucher->amount}}</td>
                    <td><b>Narration</b></td>
                    <td><b>:</b> {{$receipt_voucher->narration}}</td>
                </tr>
            </table>
        </div>
        <div class="row pt-4">
