        ...
        as $color)
                                    ...
                                    @if (1 == 1)
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $itmXsC = isset($itmXs) ? $itmXs->dateOpeningStock($date) : 0 }}
                                            </td>
                                            ...
                                            <td>{{ $itmXlC = isset($itmXl) ? $itmXl->dateOpeningStock($date) : 0 }}
                                            </td>
                                            <td>{{ $itmXxlC = isset($itmXxl) ? $itmXxl->dateOpeningStock($date) : 0 }}
                                            </td>
                                            <td>{{ $itmXxxlC = isset($itmXxxl) ? $itmXxxl->dateOpeningStock($date) : 0 }}
                                            </td>
                                            <td>{{ $itmXsC + $itmSC + $itmMC + $itmLC + $itmXlC + $itmXxlC + $itmXxxlC }}
                                            </td>
                                            <td></td>
                                            <td></td>
                                        </tr>
                                    ...
                                    @endphp
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $itmXxlC = isset($itmXxl) ? $itmXxl->dateItemStock($date) : 0 }}
                                            </td>
                                            <td>{{ $itmXxxlC = isset($itmXxxl) ? $itmXxxl->dateItemStock($date) : 0 }}
                                            </td>
                                            <td>{{$qqttyy= $itmXsC + $itmSC + $itmMC + $itmLC + $itmXlC + $itmXxlC + $itmXxxlC }}
                                            </td>
                                            @php
        ...
        as $color)
                                    ...
                                    @if (1 == 1)
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $itmXsC + $itmSC + $itmMC + $itmLC + $itmXlC + $itmXxlC  }}
                                            </td>
                                            <td></td>
                                            <td></td>
                                            <td></td>
                                    ...
                                    @endphp
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$qqttyy= $itmXsC + $itmSC + $itmMC + $itmLC + $itmXlC + $itmXxlC  }}
                                            </td>
                                            @php
                                                $itmmmm= App\PurchaseDetail::where('item_id',isset($itmXs->id)? $itmXs->id:"null")
                                                ->orWhere('item_id',isset($itmS->id)? $itmS->id:"null")
