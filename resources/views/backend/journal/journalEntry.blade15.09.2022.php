                                                            ...
                                                            <div data-repeater-item>
                                                                <div class="row justify-content-between every-form-row">
                                                                    ...
                                                                    <div class="col-md-2 col-sm-12 form-group">
                                                                        ...
                                                                        <input type="number" name="multi_total_amount" class="form-control invoice_amount" placeholder="Total Amount">
                                                                    </div>
                                                                    <div class="col-md-2 col-sm-12 form-group">
                                                                        <label for="password">Vat Rate</label>
                                                                        <select name="multi_tax_rate"  class="common-select2 form-control" style="width: 100% !important"
                                                                        required>
                                                                        @foreach ($vats as $item)
                                                                            <option value="{{ $item->id }}"
                                                                                {{ $item->id==4 ? 'selected' : '' }} >
                                                                    ...
                                                                    <div class="col-md-2 col-sm-12 form-group">
                                                                        ...
                                                                        <input type="number" name="multi_amount" class="form-control payment_amount input-due-payment"  step="any" placeholder="Amount">
                                                                    </div>
