                                ...
                                <div class="card-body pb-1">
                                    <div class="row m-1">
                                        ...
                                        <div class="col-md-1 changeColStyle">
                                            ...
                                            <input type="text" name="pi_code" id="pi_code" class="form-control inputFieldHeight" required placeholder="P Code">
                                            @error('party_info')
                                                <div class="btn btn-sm btn-danger">{{ $message }}
                                                </div>
                                            @enderror
                                        ...
                                        <div class="col-md-4 form-group non-cash-account-head" style="display: {{ isset($journalF) ? ($journalF->txn_mode == "Credit" ? '' : 'none') : 'none' }}">
