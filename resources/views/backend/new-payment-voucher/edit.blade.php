        ...
        <div class="content-wrapper">
            <div class="content-body">
                <div class="nav nav-tabs master-tab-section" id="nav-tab" role="tablist">
                    ...
                    @endif
					<a href="{{route("payment-voucher-reject-list")}}" class="nav-item nav-link" role="tab" aria-controls="nav-contact" aria-selected="false">
                        <div class="master-icon text-cente">
                                    ...
                                    <div class="card-body" style="padding-bottom: 5px;">
                                        <div class="row m-1">
                                            ...
                                            <div class="col-sm-2 changeColStyle" id="printarea">
                                                ...
                                                <input type="date" value="{{ $payment->date }}" class="form-control inputFieldHeight" name="date" id="date" placeholder="dd-mm-yyyy" >
                                                @error('date')
                                                    <div class="btn btn-sm btn-danger">{{ $message }}
                                                    </div>
                                                @enderror
