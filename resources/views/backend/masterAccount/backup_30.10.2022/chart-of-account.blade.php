    ...
    <div class="content-wrapper">
        <div class="content-body">
            <div class="nav nav-tabs master-tab-section" id="nav-tab" role="tablist">
                <a data-toggle="tab" href="#masterAccount" class="nav-item nav-link active" role="tab" aria-controls="nav-contact" aria-selected="false">
                ...
                <a data-toggle="tab" href="#accountHead" class="nav-item nav-link" role="tab" aria-controls="nav-contact" aria-selected="false">
                    <div class="master-icon text-cente">
            ...
            <div class="tab-content bg-white">
                ...
                <div id="accountHead" class="tab-pane accountHeadSection">
                    {{-- <div id="accountHead" class="tab-pane fade"> --}}
