                    ...
                    <div class="col-12 col-sm-10 col-md-10 col-lg-10">
                                    ...
                                    <div class="card-body content-padding">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-3 col-12">
                                                ...
                                                <input type="text" readonly value="{{$purchase_info->projectInfo?$purchase_info->projectInfo->proj_name:''}}" class="form-control">
                                            </div>
                                            <div class="col-sm-3 col-12">
                            ...
                            <table class="table table-sm table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col">Qty</th>
                                        <th scope="col" class="text-right pr-1">Amount</th>
                                    </tr>
                                </thead>
                        ...
                        <div class="mb-3">
                            @if ($purchase_info->status == 10)
                                <a class="btn btn-warning" href="{{route('const-raw-purchase-edit', $purchase_info->id)}}">Edit</a>
                                <a class="btn btn-info" href="{{route('const-raw-purchase-process', $purchase_info->id)}}">Process</a>
                            @endif
                            <a href="{{route('const-raw-purchase-print', $purchase_info->id)}}" class="btn btn-light" target="_blank">Print</a>
                        </div>
                    </div>
