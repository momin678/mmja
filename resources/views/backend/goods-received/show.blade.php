...
@endpush
@section('title', 'goods-received view')
@section('content')
    <!-- BEGIN: Content-->
                ...
                <div class="row" id="table-bordered">
                    <div class="col-12 col-sm-10 col-md-10 col-lg-10">
                        <form action="{{route('goods-received.store')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <table class="table table-sm table-bordered">
                                ...
                                <tbody id="tempLists"  class="user-table-body">
                                    ...
                                    <tr class="data-row">
                                        ...
                                        <td> {{$item_count}} </td>
                                        <td>
                                            <input type="hidden" value="{{$item->quantity - $item_count}}" max="{{$item->quantity - $item_count}}" min="1" required="true"  class="qty" name="qty[]">
                            ...
                            <div class="mb-3">
                                @if ($purchase_items->sum("quantity") > $total_rec_count)
                                    <a class="btn btn-warning" href="{{route('goods-received.edit', $purchase_info->id)}}">Edit</a>
