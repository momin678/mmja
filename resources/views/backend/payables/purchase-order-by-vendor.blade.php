...
@endphp
@section('title', 'Purchase Orders by Vendor')
@push('css')
                ...
                <section id="widgets-Statistics" class="mr-1 ml-1 mb-1">
                    <div class="row">
                        <div class="col-md-12  mt-2 text-center">
                            ...
                            <h5>Purchase Orders by Vendor</h5>
                        </div>
                            ...
                            <table class="table mb-0 table-sm table-hover exprortTable">
                                <thead  class="thead-light">
                                    <tr style="height: 50px;">
                                        <th>Vendor name</th>
                                        <th class="text-center">Purchase Order Count</th>
                                ...
                                <tbody class="user-table-body">
                                    ...
                                    @foreach ($customers as $key => $customer)
                                        ...
                                        <tr class="trFontSize">
                                            <td>
                                                <a href="#" class="purchase-order-by-vendor-details" id="{{$customer->id}}"> {{ $customer->pi_name }} </a>
                                            </td>
                                    ...
                                    <tr>
                                        <td>Total</td>
                                        <td class="text-center">{{$total_invoice}}</td>
