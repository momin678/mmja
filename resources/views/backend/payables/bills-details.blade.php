                            ...
                            <table class="table mb-0 table-sm table-hover">
                                ...
                                <tbody class="user-table-body">
                                    @foreach ($purchases as $key => $purchase)
                                        ...
                                        <tr>
                                            <td>
                                                @if (number_format($purchase->purchase_details->sum('total_amount')-$purchase->paid_amount->sum('paid_amount'))==0)
                                            ...
                                            <td><small>(AED)</small> {{number_format($purchase->purchase_details->sum('total_amount')-$purchase->paid_amount->sum('paid_amount'))}}</td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
