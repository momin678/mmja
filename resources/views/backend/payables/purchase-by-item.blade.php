                                    ...
                                    @foreach ($items as $key => $item)
                                        <tr class="trFontSize">
                                            ...
                                            <td class="text-center">
                                                @if ($item->purchaseItem->sum('quantity'))
                                                    {{number_format($item->purchaseItem->sum('total_amount')/$item->purchaseItem->sum('quantity'),2)}}
                                                @endif
                                            </td>
                                            <td class="text-center">{{$item->purchaseItem->sum('quantity')}}</td>
                                            <td class="text-center"><small>(AED)</small> {{$item->purchaseItem->sum('total_amount')}}</td>
                                        </tr>
                                    @endforeach
                                    <tr>
                                        <td>Total</td>
                                        ...
                                        <td class="text-center"></td>
                                        <td class="text-center"><small>(AED)</small> </td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
