                            ...
                            <table class="table mb-0 table-sm table-hover">
                                ...
                                <tbody class="user-table-body">
                                    ...
                                    @foreach ($customers as $key => $customer)
                                        ...
                                        @endphp
                                        <tr class="trFontSize">
                                            <td><a href="#"> {{ $customer->pi_name }} </a></td>
                                            <td>{{count($customer->paidAmount)}}</td>
                                            <td>0</td>
                                            <td>0</td>
                                            <td>{{count($customer->journals)}}</td>
                                            <td class="text-center"><small>(AED)</small> {{$amount-$vat_amount}}</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>0</td>
                                        <td>{{$total_journal}}</td>
                                        <td><small>(AED)</small> {{$total_amount-$total_vat}}</td>
                                        <td><small>(AED)</small> {{$total_amount}}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
