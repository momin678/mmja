...
@endphp
@section('title', 'Expenses by Project')
@push('css')
                            ...
                            <table class="table mb-0 table-sm table-hover exprortTable">
                                <thead  class="thead-light">
                                    <tr style="height: 50px;">
                                        <th>PROJECT NAME</th>
                                        <th class="text-right pr-2">EXPENSE COUNT</th>
                                ...
                                <tbody class="user-table-body">
                                    @foreach ($projects as $key => $project)
                                        @php
                                            ...
                                            foreach ($journalCount as $key => $value) {
                                               if($value->ac_head->accType->name == 'Expense'){
                                                $count++;
                                                $amount+=$value->amount;
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right pr-2">{{$count}}</td>
